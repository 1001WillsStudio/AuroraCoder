...
docker run --rm -d --name thinkwithtool-agent --env-file .env -e THINKTOOL_DOCKER=1 -e THINKTOOL_VNC=1 -v "%STORAGE_BASE%\data:/app/data" -v "%STORAGE_BASE%\workspace:/workspace" -p 8080:8080 -p 8081:8081 -p 3000:8081 -p 6080:6080 -p 8900-8902:8900-8902 thinkwithtool
if errorlevel 1 (
