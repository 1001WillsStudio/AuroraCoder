 ...
 *
 * The textarea is rows=1 (~60px from 18+18 padding and one 24px line).
 * Without this, a multiline paste stays locked at that height: later
 * lines hide in an inner scroll, and overflow:hidden on the wrapper
 * slices the top visible line against the border.
 */
