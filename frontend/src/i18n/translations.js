...
const LANG = {
  en: {
    ...
    'msg.apiKeyMissingWarning': 'No API key — this provider stays unused until you add one',
    'msg.savedWithKeyWarning': 'Settings saved. Providers without an API key stay unused until you add one.',
  ...
  zh: {
    ...
    'msg.apiKeyMissingWarning': '尚未填写 API 密钥 — 该提供方在添加密钥前不会出现在主界面',
    'msg.savedWithKeyWarning': '设置已保存。未填写 API 密钥的提供方在添加密钥前不会出现在主界面。',
